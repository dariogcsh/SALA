                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ isset($cliente->nombre)?$cliente->nombre:old('nombre') }}" required autocomplete="nombre" autofocus>
