...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h2>Estadisticas de alquileres de señal
                </h2></div>
                <div class="card-body">
                ...
                @endphp
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingFive">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> Cantidad de alquileres de señal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingOne">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> USD de alquileres de señal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingTwo">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> Cantidad de alquileres de señal por mes y año fiscal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingThree">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> USD de alquileres de señal por mes y año fiscal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingSeven">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> Duracion de alquileres de señal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                                            ...
                                            <div class="table-responsive-md">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr></tr>
                                                            <th scope="row">{{ $tipo->duracion }} meses</th>
                                                            <th scope="row">{{ $tipo->cantidad }}</th>
                                                            </tr>
                                                            @php
                                                                $nombre_ts[$rep_tipo_senal] = $tipo->duracion.' meses';
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingFour">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> Estados de alquileres de señal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                    ...
                    @endif
                    @if ($filtro=="SI")
                        <a class="btn btn-secondary float-right" href="{{ route('senal.gestion') }}">
                            ...
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingSix">
                                        ...
                                        <h4 class="mb-0">
                                            <i class="fas fa-angle-down rotate-icon"></i> Renovación de alquileres de señal
                                        </h4>
                                        </a>
                                    </div>
                                    <!-- Card body -->
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        @foreach ($alquileres_FY_pasado as $alquiler_FY_pasado)
                                                            @php
                                                                $renovacion = Senal::where([['created_at','>',$año_FY_pasado.'-10-31 23:59:59'], 
                                                        ...
                                                        @endforeach
                                                        <tr></tr>
                                                            <th scope="col">Alquileres FY {{ $año_FY_pasado }}</th>
