                    ...
                    <div class="col-md-6 divleft">
                      ...
                      <br>
                        ...
                        <div class="table-responsive-md">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 style="text-align: center">Consumo (l/hs)</h3>
                                    <div class="row">
                                      <div class="col-md-6" align="left" style="padding-left:5%">
                                        <h5><i>Referencia:</i> {{ number_format($refconsumo,1) }}</h5>
                                      </div>
                                    </div>
                                    <br>
    ...
    if ($("#valor").val() != ''){ 
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Month','Utilización de Tecnología (hs) ', 'Tiempo en acarreo (hs) '],
          ['AutoTrac™', {{ number_format($autotrac,0) }},  {{$acumtrabajandohs}} ],
          ['FieldCruise™', {{ number_format($fieldcruise,0) }},  {{$acumtrabajandohs}} ],
        ]);
        ...
        /////////------ CONSUMO--------////////
        var data = google.visualization.arrayToDataTable([
          ["Velocidad", "{{ $maquina->ModeMaq }} (l/hs)", "Consumo"],
          @for ($i=0; $i <= $periodos - 1; $i++)
              ['{{date('d/m/Y',strtotime($fechainicio[$i]))}} - {{date('d/m/Y',strtotime($fechafin[$i]))}}', 
          ...
          $('html,body').scrollTop(0);
            ...
            $('.detalle').change(function(){
              ...
              if (element_id == "detalleconsumo"){
                ...
                var path = "{{ route('utilidad.detalle_superficie_consumo_vel_tractor_acarreo') }}";
              }
              ...
              if ($(this).val() != ''){
                ...
                $.ajax({
                    ...
                    url: path,
                    method:"POST",
                    data:{value:value, _token:_token, maquina:maquina, element_id:element_id},
                    dataType: "JSON",
                    error: function(){
