            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <h5><u>Semanas</u></h5>
                                <select name="semana" id="semana" class="form-control" onchange="javascript:enviar_formulario1()">
                        ...
                        <div class="form-group col-md-2">
                            <h5><u>Estado</u></h5>
                                <select name="estado" id="estado" class="form-control" onchange="javascript:enviar_formulario1()">
                    ...
                    <br>
                    <div class="row">
                            @foreach ($pendienteplanif as $tarea)
                                <div class="col-md-2">
                                    @include('tarea.foreach')
                                </div>
                            @endforeach
                    </div>
