            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <br>
                        <div class="col-md-2">
                            <a href="{{ route('tarea.ihistorial') }}" class="btn btn-success btn-block"><b>Finalizados</b></a>
                        </div>
                    </div>
                    <br>
                    <br>
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-slide">
                            <div class="col-md-2">
                                <div class="card-header border-dark bg-light"><b><h5 align="center">A presupuestar</h5></b></div>
                                <br>
                        ...
                        <div class="swiper-slide">
                            <div class="col-md-2">
                                <div class="card-header border-dark bg-light"><b><h5 align="center">Pendiente de facturar</h5></b></div>
                                <br>
                                
                                @foreach ($pendientefacttractor as $tarea)
                                <!-- Se incluye la vista "card.blade.php" -->
                                    @include('tarea.fortractor')
                                @endforeach
                                
                                @foreach ($pendientefactcosechadora as $tarea)
                                <!-- Se incluye la vista "card.blade.php" -->
                                    @include('tarea.forcosechadora')
                                @endforeach
                               
                                @foreach ($pendientefactpulverizadora as $tarea)
                                 <!-- Se incluye la vista "card.blade.php" -->
                                    @include('tarea.forpulverizadora')
                                @endforeach
                               
                                @foreach ($pendientefactsembradora as $tarea)
                                <!-- Se incluye la vista "card.blade.php" -->
                                    @include('tarea.forsembradora')
                                @endforeach
                            </div>
