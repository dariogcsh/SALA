                ...
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            @endphp
                            <textarea id="descripcion" class="form-control @error('DescAsis') is-invalid @enderror" name="descripcion" disabled autocomplete="descripcion" autofocus rows="12">{{  isset($alerta->descripcion)?$alerta->descripcion:old('descripcion') }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="accion" class="form-control @error('accion') is-invalid @enderror" name="accion" disabled autocomplete="accion" autofocus rows="8">{{ isset($alerta->accion)?$alerta->accion:old('accion') }}</textarea>
