                ...
                <div class="card-body">   
                    <form method="POST" action="{{ url('/alerta/'.$alerta->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="descripcion" class="form-control-textarea @error('DescAsis') is-invalid @enderror" name="descripcion" value="{{ isset($alerta->descripcion)?$alerta->descripcion:old('descripcion') }}" disabled required autocomplete="descripcion" autofocus rows="12">{{ isset($alerta->descripcion)?$alerta->descripcion:old('descripcion') }}</textarea>
                        ...
                        <div class="form-group row">
                            <label for="accion" class="col-md-4 col-form-label text-md-right">{{ __('Acción/Recomendación de SALA') }}</label>

                            <div class="col-md-6">
                                <textarea id="accion" class="form-control-textarea @error('accion') is-invalid @enderror" name="accion" value="{{ old('accion') }}" autocomplete="accion" autofocus rows="8">{{ isset($alerta->accion)?$alerta->accion:old('accion') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tiempo_destinado" type="number" class="form-control" name="tiempo_destinado" value="{{ isset($alerta->tiempo_destinado)?$alerta->tiempo_destinado:old('tiempo_destinado') }}" required>
                            </div>
                        </div> 
