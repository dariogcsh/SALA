...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Agrega insumos a la mezcla de tanque') }}</div>

                <div class="card-body">
                
                    <form method="POST" action="{{ url('/mezcla/storeinsu') }}">
                        @csrf
                        <p><small> Los campos marcados con * son de caracter obligatorio</small></p> 
                        <input type="text" hidden value="{{ $mezcla->id }}" id="id_mezcla" name="id_mezcla">
                        <div class="form-group row">
                            <label for="nombre" class="col-md-4 col-form-label text-md-right">{{ __('Dá un nombre a la mezcla') }} *</label>

                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ isset($mezcla->nombre)?$mezcla->nombre:old('nombre') }}" disabled autocomplete="nombre" autofocus>
