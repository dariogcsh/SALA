...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Modificar usuario de capacitación') }}</div>

                <div class="card-body">
                
                    <form method="POST" action="{{ url('/capacitacion_user/'.$capacitacion_user->id) }}">
                        @csrf
                        @method('patch')
                        @include('capacitacion_user.form', ['modo'=>'modificar'])
