...
<!--
                    ...
                    -->
                        <div class="col-6 col-md-3">
                            <a href="{{ route('ensayo.index') }}"><img src="/imagenes/ensayos.png" class="img-fluid"  title="Red de ensayos"></a>
                            <h4 class="d-flex justify-content-center" style="text-align: center;">Red de ensayos</h3>
                            <hr>
                            <br>
                        </div>
