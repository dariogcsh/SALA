        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('reparacion.tareas_de_reparacion_taller_crear') }}">
                        @csrf
                        <p><small> Los campos marcados con * son de caracter obligatorio</small></p> 
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('N° COR') }} *</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="cor" id="cor" required autofocus> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('Cliente') }} *</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="cliente" id="cliente" required autofocus> 
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" name="horas_de_trilla" id="horas_de_trilla"> 
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="fecha_salida" id="fecha_salida" required autofocus> 
                            </div>
                        </div>
                        <div class="tareas">
