                    ...
                    @csrf
                        <div class="container">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="descripcion" rows="5" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" disabled autofocus>{{ isset($tarea->descripcion)?$tarea->descripcion:old('descripcion') }}</textarea>
