...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h2>Progreso de los trabajos</h2></div>
                <div class="card-body">
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="col-md-2">
                                    <div class="card-header border-dark bg-light"><b><h5 align="center">Programado diario</h5></b></div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card-header border-dark bg-light"><b><h5 align="center">En ejecución</h5></b></div>
                                @foreach ($tecnicos as $tecnico)
                                <div class="card-header border-dark bg-light"><b><h5 align="center">{{ $tecnico->name }} {{ $tecnico->last_name }}</h5></b></div>
                                    @for($i = 0; $i < $repetitiva; $i++)
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card-header border-dark bg-light"><b><h5 align="center">Pausado</h5></b></div>
                                @foreach ($tecnicos as $tecnico)  
                                <div class="card-header border-dark bg-light"><b><h5 align="center">{{ $tecnico->name }} {{ $tecnico->last_name }}</h5></b></div>                        
                                    @for($i = 0; $i < $repetitiva; $i++)
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card-header border-dark bg-light"><b><h5 align="center">Esperando autorización / pieza</h5></b></div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card-header border-dark bg-light"><b><h5 align="center">Pieza recibida</h5></b></div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2"><div height="100%" class="card-header border-dark bg-light"><b><h5 align="center">Programado diario</h5></b></div></div>
                        <div class="col-md-2"><div height="100%" class="card-header border-dark bg-light"><b><h5 align="center">En ejecución</h5></b></div></div>
                        <div class="col-md-2"><div height="100%" class="card-header border-dark bg-light"><b><h5 align="center">Pausado</h5></b></div></div>
                        <div class="col-md-2"><div height="100%" class="card-header border-dark bg-light"><b><h5 align="center">Esperando autorización / pieza</h5></b></div></div>
                        <div class="col-md-2"><div height="100%" class="card-header border-dark bg-light"><b><h5 align="center">Pieza recibida</h5></b></div></div>
                    </div>
                       @php
                           $num = 0;
                       @endphp
