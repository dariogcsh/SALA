                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control @error('NumSMaq') is-invalid @enderror" id="NumSMaq" name="NumSMaq" value="{{ isset($jdlink->NumSMaq)?$jdlink->NumSMaq:old('NumSMaq') }}" readonly autofocus>
                                        @isset($jdlink) 
