    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @can('haveaccess','asist.gestion')
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('asist.gestion') }}" class="btn btn-primary btn-block"><b>Estadisticas de asistencias</b></a>
                        </div>
                    </div>
                    <br>
                @endcan
                ...
                <div class="table-responsive-md">
                    ...
                    <div class="d-flex justify-content-center">
                        {!! $asistencias->onEachSide(0)->links() !!}
                    </div>                    
                </div>
            </div>
        </div>
