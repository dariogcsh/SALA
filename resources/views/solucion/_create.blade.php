            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    -->
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <textarea id="DescSolu" class="form-control @error('DescSolu') is-invalid @enderror" name="DescSolu" value="{{ old('DescSolu') }}"  placeholder="Respuesta" rows="6" autofocus></textarea>
                                @error('DescSolu')
