                ...
                <form action="" method="post">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="anexo" class="form-control-textarea @error('anexo') is-invalid @enderror" name="anexo" value="{{ old('anexo') }}" autocomplete="anexo" autofocus rows="8" disabled>@isset($reclamo->anexo){{ $reclamo->anexo }}@endisset</textarea>
