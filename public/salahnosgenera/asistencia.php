    ...
    <script type="text/javascript">
             $(document).ready(function(){
              $('#solicitud').on('click',function(){
                      ...
                      if(tipoasis==""){
                        alert("Por favor, seleccione el tipo de asistencia");
              ...
              <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6">
                      ...
                      <form style="align-items: center; padding-top: 100px;">
                        ...
                        <div class="form-group">                                        
                          ...
                          <div class="form-group">   
                              <select class="selectpicker form-control" data-live-search="true" title="Tipo Asistencia" id="asistencia">
                                  <?php 
                                    while ($row = mysqli_fetch_array($asistencia)) {
                                            echo "<option value='". $row["CodiTiAs"] ."'>". $row["NombTiAs"] ."</option>";
                                          }
                                    ?>
                              </select>                             
                           </div>
