...
<head>
   <?php 
      ...
      $url = "https://agrotecnologiasala.com.ar/salahnosgenera/eficienciatrigo.php?desde1=".$desde[0]."%26hasta1=".$hasta[0]."%26desde2=".$desde[1]."%26hasta2=". $hasta[1] ."%26desde3=". $desde[2] ."%26hasta3=". $hasta[2] ."%26desde4=". $desde[3] ."%26hasta4=". $hasta[3] ."%26desde5=". $desde[4] ."%26hasta5=". $hasta[4] ."%26desde6=". $desde[5] ."%26hasta6=". $hasta[5] ."%26desde7=". $desde[6] ."%26hasta7=". $hasta[6] ."%26desde8=". $desde[7] ."%26hasta8=". $hasta[7] ."%26desde9=". $desde[8] ."%26hasta9=". $hasta[8] ."%26desde10=". $desde[9] ."%26hasta10=". $hasta[9] ."%26cboorg=". $idorganizacion ."%26periodo=". $opt ."%26maq=". $maquina ."";
   ...
   <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <?php 
              ...
              for ($z=0; $z <= $opt; $z++) {
                  ...
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Ralentí",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  ...
                  // ---------------------------------HR TRANSPORTE------------------------------
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Transporte",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // ---------------------------------HR TRABAJANDO------------------------------
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Trabajando",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Ralentí con depósito de grano no lleno",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Ralentí con depósito de grano lleno",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Separador de virajes en cabecero engranado",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // ---------------------------------HR COSECHA------------------------------
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Cosecha",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Cosecha y descarga",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Descarga no cosechando",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Transporte a más de 16 km/h (10 mph) o interruptor de carretera conectado",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia($segmento,"hr","Transporte a menos de 16 km/h (10 mph), separador desconectado",$desde[$z],$hasta[$z],"0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // ---------------------------------KM/HR TRABAJANDO------------------------------
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia_promedios($segmento,"km/hr","Trabajando",$desde[$z],$hasta[$z],"3","0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // ---------------------------------L/HR TRABAJANDO------------------------------
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia_promedios($segmento,"l/hr","Trabajando",$desde[$z],$hasta[$z],"10","0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  // Comienzo de calculo el valor correspondiente
                  $valorbuscado = $res->datos_eficiencia_promedios($segmento,"%","Trabajando",$desde[$z],$hasta[$z],"40","0");
                  unset($valorarray1);
                  unset($valorarray2);
                  $o = 0;
                  while ($fila = mysqli_fetch_array($valorbuscado)) {
                  ...
                  if ($z == $opt) {
                    ...
                    $horasensoja = $res->horas_en($maquina, 'hr', 'Tiempo en Trigo', 'Hora', $desde[$z], $hasta[$z]);
        ...
        chart.draw(view, options);
         ...
         <?php echo "['Month','Utilización de Tecnología: ', 'Tiempo en Trigo: ','Tiempo de Cosecha: ']," ;
    ...
    <img src="imagen/caratula.png" class="responsive" width="100%">
      ...
      <br>
            <div class="container-fluid">
              <img src="imagen/Trigo.jpg" class="responsive" width="100%">
