...
<head>
   <?php 
      ...
      $url = "https://agrotecnologiasala.com.ar/eficiencia2.php?desde1=".$desde[0]."%26hasta1=".$hasta[0]."%26desde2=".$desde[1]."%26hasta2=". $hasta[1] ."%26desde3=". $desde[2] ."%26hasta3=". $hasta[2] ."%26desde4=". $desde[3] ."%26hasta4=". $hasta[3] ."%26desde5=". $desde[4] ."%26hasta5=". $hasta[4] ."%26desde6=". $desde[5] ."%26hasta6=". $hasta[5] ."%26desde7=". $desde[6] ."%26hasta7=". $hasta[6] ."%26desde8=". $desde[7] ."%26hasta8=". $hasta[7] ."%26desde9=". $desde[8] ."%26hasta9=". $hasta[8] ."%26desde10=". $desde[9] ."%26hasta10=". $hasta[9] ."%26cboorg=". $idorganizacion ."%26periodo=". $opt ."%26maq=". $maquina ."%26ancho=". $UM ."";
        ...
        // GRAFICO DE FACTOR DE SUPERFICIE-----------------------------------
         ...
         <?php echo "['Month', 'Promedio: ' + ". $superficieprom .", 'Mejor valor: ' + ". $superficiemejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
            // Utilizamos switch para obtener los valores de fecha desde y fecha hasta y utilizarlos en la 
         ...
         <?php echo "['Month', 'Promedio: ' + ". $consumoprom .", 'Mejor valor: ' + ". $consumomejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $consumoprom .", ". $consumomejor .", ". $consumoreal ."],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $velocidadprom .", 'Mejor valor: ' + ". $velocidadmejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $velocidadprom .",    ". $velocidadmejor .",       ". $velocidadreal ."],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $factorcargaprom .", 'Mejor valor: ' + ". $factorcargamejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $factorcargaprom .",    ". $factorcargamejor .",       ". $factorcargareal ."],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $ralentiprom .", 'Mejor valor: ' + ". $ralentimejor .",  '',{role:'annotation'}]," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $ralentiprom .",    ". $ralentimejor .", ". $ralentireal .", '". $ralentireal ."' + ''],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $ralentillenoprom .", 'Mejor valor: ' + ". $ralentillenomejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $ralentillenoprom .",    ". $ralentillenomejor .",       ". $ralentillenoreal ."],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $ralentivacioprom .", 'Mejor valor: ' + ". $ralentivaciomejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $ralentivacioprom .",    ". $ralentivaciomejor .",       ". $ralentivacioreal ."],";
          } ?>
        ]);
         ...
         <?php echo "['Month', 'Promedio: ' + ". $separadorprom .", 'Mejor valor: ' + ". $separadormejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
           ...
           if ($r == $opt) {
            ...
            echo "['P ' + '". $g ."',  ". $separadorprom .",    ". $separadormejor .",       ". $separadorreal ."],";
          } ?>
        ]);
    ...
    <img src="imagen/caratula.png" class="responsive" width="100%">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4" align="center">
            <?php
            echo "<a class='btn btn-success btn-block' href='whatsapp://send?text=Muy%20buenos%20dias,%20adjuntamos%20informe%20de%20eficiencia%20de%20la%20máquina,%20para%20visualizarlo,%20toca%20el%20siguiente%20link%20y%20espera%2030%20segundos%20a%20que%20cargue%20la%20página%20web.%20Desde%20ya%20muchas%20gracias.%20". $url ."' data-action='share/whatsapp/share'>Compartir por WhatsApp</a>" ;
