<?php
		...
		$subject = "Informe de Eficiencia de Maquina";
		$message = "Muy buenas tardes, adjuntamos informe de eficiencia de maquina cosechando cultivo de grano fino. Para visualizarlo solo debe ingresar al siguiente enlace: " . $url. "\r\n \r\n" ."Cualquier consulta quedamos a disposicion. \r\n \r\n Saludos Cordiales. \r\n \r\n Atte. Dario Garcia Campi - Sala Hnos." ;
 		if ($to <> "") {
