    ...
    <?php 
              ...
              for ($z=0; $z <= $opt; $z++) {
                  ...
                  for ($i=0; $i < $cantmaq; $i++) {
                    if ($i == $p) {
                      if ($UM == "pies") {
                        $matriz[$i]["superficie"] = $medida*0.3048*$matriz[$i]["kmtrabajando"]*0.1;
                      }else{
                        $matriz[$i]["superficie"] = $medida*$matriz[$i]["kmtrabajando"]*0.1;
                      }
                        if ($matriz[$i]["ltrabajando"] <> 0 AND $matriz[$i]["superficie"] <> 0) {
        ...
        // GRAFICO DE FACTOR DE SUPERFICIE-----------------------------------
         ...
         <?php echo "['Month', 'Promedio: ' + ". $superficieprom .", 'Mejor valor: ' + ". $superficiemejor .",  '']," ;
          ...
          for ($r=0; $r <= $opt ; $r++) { //Cada bucle representa una barra del grafico o un periodo
            ...
            echo "['P ' + '". $g ."',  ". $superficieprom .",    ". $superficiemejor .",       ". $superficiereal ."],";
          } ?>
        ]);
